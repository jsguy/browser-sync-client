...
exports.socketEvent = function (bs, eventManager) {
    ...
    return function (data) {
        ...
        //var elem = $(window.document).xpath('//*[@id="js-image-gallery__inner"]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/img[1]')
        
        console.log('data.xpath', data.xpath);

        var elem = $(document.body).xpath(data.xpath).get(0);
